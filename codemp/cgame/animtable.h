...
//===End Saber locks==================================================================
	...
	ENUM2STRING(BOTH_LEDGE_GRAB),
	ENUM2STRING(BOTH_LEDGE_HOLD),
	ENUM2STRING(BOTH_LEDGE_LEFT),
	ENUM2STRING(BOTH_LEDGE_RIGHT),
	ENUM2STRING(BOTH_LEDGE_MERCPULL),

	ENUM2STRING(BOTH_MELEE_BACKKICK),
	ENUM2STRING(BOTH_MELEE_SPINKICK),
	ENUM2STRING(TORSO_MAND_FLAME),

	ENUM2STRING(BOTH_STAND1TO2_NEW),
	ENUM2STRING(BOTH_STAND2TO1_NEW),
	ENUM2STRING(BOTH_S1_S7_NEW),
	ENUM2STRING(BOTH_S7_S1_NEW),
	ENUM2STRING(BOTH_S6_S1_LARM),
	ENUM2STRING(BOTH_S1_S6_LARM),
	ENUM2STRING(BOTH_S6_S1_2ARMS),
	ENUM2STRING(BOTH_S1_S6_2ARMS),

	ENUM2STRING(BOTH_BACK_FALLING),
	ENUM2STRING(BOTH_BACK_FALLING_GETUP),
	ENUM2STRING(BOTH_BACK_FALLING_GETUP_SLOW),

	ENUM2STRING(BOTH_JUMP_BACKKICK_SPIN),

	ENUM2STRING(BOTH_JUMP_BACKFLIP_ATCK),
	ENUM2STRING(BOTH_JUMP_BACKFLIP_ATCKEE),
	ENUM2STRING(BOTH_JUMP_BACKFLIP_ATCKEE_FALL),

	ENUM2STRING(BOTH_NEW_STABER),
	ENUM2STRING(BOTH_NEW_STABEE),

	ENUM2STRING(BOTH_FLIP_STAB),
