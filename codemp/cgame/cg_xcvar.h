...
// Client-side "fake" noclip: fly around locally while the server keeps us frozen
...
XCVAR_DEF( cg_smoothTimenudge,					"1",	NULL,					CVAR_TEMP )
...
#define TRAP_DIAGRAM_HELPER 1
#if TRAP_DIAGRAM_HELPER
XCVAR_DEF( cg_trapDiagram, "0", NULL, 0 )
XCVAR_DEF( cg_trapDiagramTarget, "-1", NULL, 0 )
#endif
...
XCVAR_DEF( se_language,						"english",					CVU_LanguageModified,	CVAR_ARCHIVE|CVAR_NORESTART )
