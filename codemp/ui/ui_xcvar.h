...
XCVAR_DEF( ui_disableWeaponSway,			"1",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
...
XCVAR_DEF( ui_freeSaber,					"0",					NULL,				CVAR_INTERNAL )
...
XCVAR_DEF( ui_selectedModelIndex,			"-1",		UI_UpdateSelectedModelIndex,	CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( model,				DEFAULT_MODEL"/default",	UI_PlayerModelChanged,		CVAR_USERINFO|CVAR_ARCHIVE ) //would probably be better to have the vmCvar renamed to something else, but oh are we blessed with this xcvar system
...
XCVAR_DEF( ui_username,						"",						NULL,				CVAR_ARCHIVE|CVAR_INTERNAL|CVAR_NORESTART )
...
XCVAR_DEF( cg_tauntAntiSpam,				"1",					NULL,				CVAR_ARCHIVE )
XCVAR_DEF( ui_headCount,					"-1",					NULL,				CVAR_ARCHIVE|CVAR_INTERNAL|CVAR_ROM )
XCVAR_DEF( ui_modelSearch,					"",					CVU_UpdateModelSearch,	CVAR_INTERNAL )
XCVAR_DEF( ui_speciesSearch,					"",					CVU_UpdateSpeciesSearch,	CVAR_INTERNAL )
XCVAR_DEF( ui_speciesSearchCount,			"0",					NULL,				CVAR_INTERNAL|CVAR_ROM )
XCVAR_DEF( ui_showAllSkins,					"0",				CVU_UpdateQ3ModelList,	CVAR_ARCHIVE_ND )
XCVAR_DEF( cg_modelBlacklist,				"",					CVU_UpdateModelList,	CVAR_ARCHIVE )
