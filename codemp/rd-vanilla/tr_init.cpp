...
void R_Register( void )
{
	...
	r_overBrightBits					= ri.Cvar_Get( "r_overBrightBits",					"0",						CVAR_ARCHIVE_ND, "" );
	r_mapOverBrightBits					= ri.Cvar_Get( "r_mapOverBrightBits",				"0",						CVAR_ARCHIVE_ND, "" );
	...
	r_measureOverdraw					= ri.Cvar_Get( "r_measureOverdraw",					"0",						CVAR_TEMP, "" );
	r_lodscale							= ri.Cvar_Get( "r_lodscale",						"16",						CVAR_ARCHIVE_ND, "" );
	...
	r_shadowRange						= ri.Cvar_Get( "r_shadowRange",					"1000",							CVAR_TEMP, "" );
