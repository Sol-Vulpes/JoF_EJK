...
//JAPRO - Serverside - Get Clients Mod version, if any - Start
	...
	if ( !strcmp( s, "1.4JAPRO" ) || !strcmp( s, JOFCLIENTVERSION )) { //this should be changed to !Q_stricmpn
...
#if 1 //re-enabled for now //#if 0 //disabled for now
