...
#if defined(_DEBUG)
	#define	JK_VERSION		"(debug)Sol's JoF EJK: " SOURCE_DATE
	#define JK_VERSION_OLD	"(debug)JAmp: v" VERSION_STRING_DOTTED
#elif 0//defined (TOURNAMENT_CLIENT)
	#define JK_VERSION		"Sol's JoF EJK: Tournament Client"
	#define JK_VERSION_OLD	"JAmp: v" VERSION_STRING_DOTTED
#else
	#define	JK_VERSION		"Sol's JoF EJK: " SOURCE_DATE
	#define JK_VERSION_OLD	"JAmp: v" VERSION_STRING_DOTTED
#endif
